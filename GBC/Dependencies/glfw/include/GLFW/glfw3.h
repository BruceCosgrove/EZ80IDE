...
/*! @brief The vertical and horizontal resize arrow shape.
 *
 *  The vertical and horizontal resize arrow shape.
 */
#define GLFW_RESIZE_ALL_CURSOR         0x00036007
/*! @brief The NE -> SW resize arrow shape.
 *
 *  The NE -> SW resize arrow shape.
 */
#define GLFW_RESIZE_NESW_CURSOR         0x00036008
/*! @brief The NW -> SE resize arrow shape.
 *
 *  The NW -> SE resize arrow shape.
 */
#define GLFW_RESIZE_NWSE_CURSOR         0x00036009
/*! @brief The not allowed arrow shape.
 *
 *  The not allowed arrow shape.
 */
